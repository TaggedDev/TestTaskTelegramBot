...
namespace TestTaskTelegramBot
{
    class Program
    {
        ...
        private static void LoadDB()
        {
            ...
            /*DatabaseHandler.ExecuteSQL("DROP TABLE orders");*/
            DatabaseHandler.ExecuteSQL("CREATE TABLE IF NOT EXISTS orders (order_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, order_time TIMESTAMP, chat_id INTEGER, cart VARCHAR(255))");
            ...
            DatabaseHandler.ExecuteSQL("INSERT INTO items VALUES (2, \'Курица в соевом соусе\', \'Куриное филе, маринованное в соевом соусе с гарниром из риса\', 560, \'https://img.povar.ru/main/a1/8f/ca/2a/kurica_v_medovo-soevom_souse_s_kunjutom-483793.jpg', \'15 мин\', \'main_course\')");
